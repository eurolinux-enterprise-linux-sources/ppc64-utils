...
%endif
Requires: binutils
Requires: powerpc-utils kernel-bootwrapper libvpd lsvpd
%if 0%{?fedora}
Requires: ps3-utils
%endif
...
* Fri Oct 05 2012 Karsten Hopp <karsten@redhat.com> 0.14-13
- require ps3-utils in Fedora only

* Sat Jul 21 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.14-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_18_Mass_Rebuild

* Fri May 04 2012 Karsten Hopp <karsten@redhat.com> 0.14-11
- rebuild

* Sat Jan 14 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.14-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_17_Mass_Rebuild

* Wed Feb 09 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0.14-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Wed Feb 17 2010 Roman Rakus <rrakus@redhat.com> 0.14-8
- Removed every lines in all sections.

* Thu Jan 28 2010 Roman Rakus <rrakus@redhat.com> - 0.14-7
- Added lsvpd and libvpd to dependency

* Tue Nov 10 2009 Roman Rakus <rrakus@redhat.com> - 0.14-6
- Remove powerpc-utils-papr from requires, since powerpc-utils provides it
